...
def test_load_experiment_from_yaml() -> None:
    ...
    assert config.experiment_id == "harbor-openhands-laguna"
    ...
    assert config.provider.type == "laguna"
    assert config.provider.prefix == "litellm_proxy"
...
def test_compiler_expands_task_agent_model_attempt() -> None:
    ...
    assert all(trial.experiment_id == "harbor-openhands-laguna" for trial in trials)
    ...
    assert {trial.trial_id for trial in trials} == {
        ...
        "harbor-openhands-laguna::health-api::openhands::model2::1",
        "harbor-openhands-laguna::health-api::openhands::model3::1",
        "harbor-openhands-laguna::health-api::openhands::model4::1",
        "harbor-openhands-laguna::health-api::openhands::model5::1",
    }
